<div class="generic-container">
	<div class="panel panel-default">
		...
		<div class="panel-heading">
			<span class="lead">Tutorial</span>
		</div>
		<div class="panel-body">
			<div class="table-responsive" style="padding: 12px">
				<h2>How to use GoToStock Efficiently?</h2>
				...
				<div align="center" style="padding-left: 10px" id="link_bar"> <a style="font-weight:bold;" href="https://api.whatsapp.com/send?phone=916361059258">Click here and message to receive Stock updates</a> </div>
					</br>
					</br>
