...
app.constant('urls', {
    BASE: 'http://ec2-35-154-149-44.ap-south-1.compute.amazonaws.com:8080/MarketBuzzApp',
    MARKET_TIP_SERVICE_API : 'http://ec2-35-154-149-44.ap-south-1.compute.amazonaws.com:8080/MarketBuzzApp/api/marketTip/',
});
