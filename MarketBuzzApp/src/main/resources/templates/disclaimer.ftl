	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="table-responsive"
				style="padding: 25px; font-weight: normal">
				<label style="color: #2b8341; font-size: 16px; font-weight: normal;">GoToStock
					...
					risky too. Nobody can be 100% Sure in the share market. GoToStock
					site / Application is not responsible for any losses incurred by
					acting on the our recommendations or our view. You should be aware
					of risk in trading using our recommendations (share tips services).
					Investors are advised to take the services of a competent
					'Investment Adviser', before making any investment decision. The
					targets expressed are based on technical and fundamental analysis
