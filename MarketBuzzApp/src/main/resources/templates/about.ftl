	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="table-responsive" style="padding: 25px">
				...
				traders and investers to buy / sell appropriate stocks. We try to give the Stock suggestions after observing the Market trend of Indian Share Market.
				</label>
				</br>
				<h2>Stock tips:</h2>
				...
				<label style="color: #2b8341; font-size:20px; font-weight:bold">Mobile Version: <a href="https://play.google.com/store/apps/details?id=com.gotostock.market_tips">Android App Link:</a></label>
				</br>
				...
				<label style="color: #2b8341; font-size:20px; font-weight:normal"><a href="https://t.me/gotostock">Telegram Channel Link</a> : <a href="https://t.me/gotostock">https://t.me/gotostock</a></label>
				</br>
				</br>
